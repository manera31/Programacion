...
public class Principal {
    ...
    public static void main(String[] args) {
        /*
         *  El método main muestra el mensaje de bienvenida y seguido llama al método de introducir el número para jugar.
         *  Después de esto limpia la pantalla y muestra las diferentes opciones del juego. Esto se repite hasta que el jugador
         *  quiera salir del juego.
         */
        Lib.limpiarPantalla();
        System.out.println("***************************************************");
    ...
    private static int menuPrincipal() {
        /*
         *  Este método muestra el menú principal. Muestra por pantalla el menú y pide al juagdor un número de este.
         *  El método comprueba que el número introducido por el jugador este dentro de las opciones validas.
         *  Finalmente devuelve este número.
         */
        int opcion;
        do {
            Lib.limpiarPantalla();
    ...
    private static void introducirNumero(){
        /*
         *  Este método lo utilizo para darle la opción al usuario de introducir él el número del boleto que quiere jugar
         *  o que se genere aleatoriamete.
         *  El metodo valida que la combnacion que introduce el jugador no se repite.
         *  Finalmente muestra por pantalla el boleto del jugador.
         */
        char aux ;
    ...
    private static void opcion1() {
        /*
         *  Este método es la primera opción del menú.
    ...
    private static void opcion2() {
        /*
         *  Este método corresponde con la segunda opción del menú.
    ...
    private static void verLosDosBoletos(){
        ...
        System.out.printf("*%13s%2d%26s%4s%18s%3d%20s\n", "Reintegro: ", administracion.getBoleto().getReintegro(), "*", "*", "Complementario: ", administracion.getSorteo().getComplementarioGanador(), "*");
        System.out.printf("*%41s%4s%13s%2d%26s\n", "*", "*", "Reintegro: ", administracion.getSorteo().getReintegroGanador(), "*");
        System.out.printf("*%41s%4s%41s\n", "*","*","*");
        System.out.println("******************************************   ******************************************");
